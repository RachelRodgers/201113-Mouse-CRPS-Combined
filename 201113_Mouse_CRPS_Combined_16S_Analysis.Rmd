...
<li>combined cohort:</li>
<ul>
  <li>combined controls</li>
...
```{r sampleDataModified, results='hide'}
...
physeqTrimmed # 942 taxa x 207 samples
```
...
```{r save-sampleDataBacteria, echo=FALSE, include=FALSE}
